...
model = smf.ols('unemp_rate ~ EPU_C_LFD + C(state)', data=df_merged)
results = model.fit()

print(results.summary())
print("The regression model estimates the impact of the log-first-difference of EPU-C on the "
      "unemployment rate, including fixed effects for states. The significance of the "
      "coefficients, reflected in the p-values, and the proportion of variance explained, "
      "indicated by the R-squared value, help understand the relationship's strength and relevance.")
